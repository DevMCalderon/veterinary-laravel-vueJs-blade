...
<div class="row g-2 mt-2">
    ...
    <div class="col-sm-6"><a class="btn btn-outline-facebook btn-sm d-block w-100" href="{{ url('login/facebook') }}"><span class="fab fa-facebook-square me-2" data-fa-transform="grow-8"></span> Facebook</a></div>
</div>
@endsection