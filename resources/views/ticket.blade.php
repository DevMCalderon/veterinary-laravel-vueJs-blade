...
<div id="showScroll" class="container">
    <div class="receipt">
        <h1 class="logo"><img src="https://www.labcell.com.mx/images/icono.png"
        ...
        <div class="returnPolicy bold" style="font-size:50%;">
            ...
            Es indispensable presentar este comprobante para recoger equipo. <br>Despues de 30 dias no nos hacemos
            responsables por equipos no reclamados. <br>La garantia aplica en reparaciones con una vigencia de 30 dias
            naturales y se aplica presentando este comprobante o el ticket fisico. <br>Quejas o sugerencias en
            https://labcell.com.mx/quejas </div>
        <div class="feedback">
            <div class="break">
                ***********************************
            </div>
            <p class="center">
                Este es unicamente un ticket electronico que se podra utilizar como remplazo en caso de perdida total o
                parcial del ticket fisico, este ticket no presenta la misma informacion del ticket fisico por lo que en
                ciertas ocasiones se requerira el ticket fisico, los beneficios del programa LABCELL Te premia son
                unicamente para los socios activos.</p>
